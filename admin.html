        ...
        <main id="admin-main">
            <section id="explorer-panel">
                ...
                <div id="publish-section">
                    <button id="publish-btn"><i class="fas fa-upload"></i> Publish</button>
                </div>
            </section>
            <section id="editor-section" class="hidden">
                <form id="file-editor-form">
                    ...
                    <div id="editor-controls">
                        ...
                        <button type="button" id="close-editor-btn"><i class="fas fa-times-circle"></i> Close</button>
                    </div>
                </form>
            </section>
        </main>
